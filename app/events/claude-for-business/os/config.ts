    ...
    beats: [
      ...
      },
      {
        id: 'ns4', title: 'Lead with the Bootcamp', speaker: 'ABIE', blocks: [
          ...
          { type: 'scripted', speaker: 'ABIE', text: "I want to be honest about why it's €197. This is Cohort 1. We're building this with you, not just for you. That's worth something ~ and we're pricing it like it is. Cohort 2 opens at €397. Not a threat, just a fact. This is the founding price and it closes tonight." },
          ...
          { type: 'scripted', speaker: 'ABIE', text: "€197 tonight. €594 of value. Midnight the VIP goes back to full price. That window closes the moment you close this tab." },
      ...
      },
      {
        id: 'ns6', title: 'Three doors out', speaker: 'BOTH', blocks: [
          ...
          { type: 'scripted', speaker: 'BOTH', text: "And if the bootcamp is calling you ~ the link is in the chat. Cohort 1 closes at midnight. €197 tonight, €397 next cohort. That's the only version of this price that exists." },
        ],
      },
      {
