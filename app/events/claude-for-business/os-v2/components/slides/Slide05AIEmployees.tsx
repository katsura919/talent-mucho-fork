...
export function AIEmployeeCapabilities({
  ...
  return (
    <div style={{ maxWidth: 1500, margin: "32px auto 0" }}>
      <div
        style={{
          ...mono,
          fontSize: sz(11),
      ...
      <div style={{ marginBottom: 8, maxWidth: 860 }}>
        <span
          style={{
            ...sans,
            fontSize: sz(28),
...
export function AIEmployeeLevels({
  C,
  mono,
  sans,
  serif,
        ...
        {AI_LEVELS.map((lvl, i) => (
          <div
            ...
            style={{
              ...
              border: `1px solid ${C.border}`,
              display: "grid",
              gridTemplateColumns: `${sz(120)}px 1fr ${sz(320)}px`,
              gap: 22,
              alignItems: "start",
            }}
          >
...
// ── AIEmployeeLayers (legacy wrapper) ───────────────────────────────────────

export function AIEmployeeLayers(props: SlideProps) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 44 }}>
      <AIEmployeeCapabilities {...props} />
      <AIEmployeeLevels {...props} />
    </div>
  );
}
      ...
      >
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    borderRadius: 12,
                    background: isAct ? `${C.primary}12` : "transparent",
                      ...
                      style={{
                        ...
                        background: isAct
                          ...
                          : isPast
                            ? `${C.primary}50`
                            : C.surface,
                        border: `2px solid ${isAct ? C.primary : C.border}`,
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        color: isAct
                          ...
                          : C.text,
                        transition: "all 0.2s",
                        boxShadow: isAct ? `0 0 0 4px ${C.primary}25` : "none",
                      }}
                    >
                      <Icon size={sz(18)} strokeWidth={2} />
                    </div>
                  </div>
                  <div>
                    <div
        ...
        >
          ...
          >
            ...
            >
              <ActiveIcon size={sz(30)} strokeWidth={2} />
            </div>
            <div>
              <div
                style={{
